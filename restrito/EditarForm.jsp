  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <a href="../ServletAutent" class="btn btn-danger" role="button">Sair</a>
          </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
...
<div class="form-group">
  ...
  <textarea class="form-control" rows="15" name="ementaf"><%=rs.getString("ement")%></textarea>
</div>

<div class="form-group">
  <label for="compHf">Competências e Habilidades a serem desenvolvidas:</label>
  <textarea class="form-control" rows="15" name="compHf"><%=rs.getString("CompH")%></textarea>
</div>

<div class="form-group">
  <label for="contPf">Conteúdo Programático:</label>
  <textarea class="form-control" rows="20" name="contPf"><%=rs.getString("ContP")%></textarea>
</div>

<div class="form-group">
  <label for="atividPf">Atividades Programadas:</label>
  <textarea class="form-control" rows="15" name="atividPf"><%=rs.getString("atividP")%></textarea>
</div>

<div class="form-group">
  <label for="avalif">Avaliação:</label>
  <textarea class="form-control" rows="10" name="avalif"><%=rs.getString("avaliac")%></textarea>
</div>

<div class="form-group">
  <label for="bibliGf">Bibliografia Geral:</label>
  <textarea class="form-control" rows="15" name="bibliGf"><%=rs.getString("bibliG")%></textarea>
</div>

<div class="form-group">
  <label for="bibliCf">Bibliografia Complementar:</label>
  <textarea class="form-control" rows="15" name="bibliCf"><%=rs.getString("bibliC")%></textarea>
</div>
<% 
}//Fim do while
